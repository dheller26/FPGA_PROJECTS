...
proc create_root_design { parentCell } {
  ...
  set valid_pixel [ create_bd_port -dir I valid_pixel ]
  ...
  connect_bd_net -net clk_wiz_pll_locked [get_bd_pins clk_wiz_pll/locked] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins util_vector_logic_1/Res] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net valid_pixel_1 [get_bd_ports valid_pixel] [get_bd_pins write_buffer_manager_0/we]
